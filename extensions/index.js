...
const EXTENSIONS = [
  ...
  { id: 'EXT-027', slug: 'sovereign-command-pilot', name: 'Sovereign Command Pilot', engines: ['SovereignPlanner', 'ProfileRouter', 'ProductionGuard'], ring: 'Build Ring', wire: 'intelligence-wire/sovereign-command', userExperience: 'Production user-facing sovereign command pilot — describe a task and get an executable production plan routed for build, test, security, and delivery workflows.' },
  { id: 'EXT-028', slug: 'ci-pilot-embodied', name: 'CI Pilot Embodied', engines: ['CIPilotEmbodiment', 'GitHubCopilotAdapter', 'PipelinePulse'], ring: 'Counsel Ring', wire: 'intelligence-wire/ci-pilot', userExperience: 'Production user-facing CI copilot embodiment — paste failing pipeline context and get triage severity, embodied CI guidance, and patch-first recovery recommendations.' },
  { id: 'EXT-029', slug: 'law-firm-economy-counsel', name: 'Law Firm Economy Counsel', engines: ['MatterRouter', 'WorkflowBuilder', 'EconomySignalEngine'], ring: 'Counsel Ring', wire: 'intelligence-wire/law-economy', userExperience: 'Everyday user-facing legal operations copilot for law firms — analyzes matters, drafts workflow lanes, and surfaces legal-economy pressure signals for better decisions.' }
];
