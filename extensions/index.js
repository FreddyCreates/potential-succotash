 ...
 *
 * 31 multi-modal, multi-AI Edge extensions wired into the sovereign organism.
...
const EXTENSIONS = [
  ...
  { id: 'EXT-026', slug: 'register', name: 'Register', engines: ['RegisterWorker', 'MutationObserver', 'IntersectionObserver', 'PerformanceObserver', 'ResizeObserver'], ring: 'Build Ring', wire: 'intelligence-wire/register', userExperience: 'Builder AI — one-click install for all 31 extensions. Scans, validates, packages, and deploys extensions natively via Web Workers. Click install — extensions are live in Chrome/Edge/Brave. No manual steps.' },
  { id: 'EXT-027', slug: 'windows-copilot-hub', name: 'Windows Copilot Hub', engines: ['GPT', 'Claude', 'Gemini', 'Llama'], ring: 'Interface Ring', wire: 'intelligence-wire/copilot', userExperience: 'Unified Windows Copilot Intelligence — multi-model fusion with GPT + Claude + Gemini + Llama. Phi-weighted reasoning, alpha routing, and side-panel copilot experience native to Edge on Windows.' },
  { id: 'EXT-028', slug: 'windows-file-oracle', name: 'Windows File Oracle', engines: ['Embeddings', 'Florence', 'CLIP'], ring: 'Memory Ring', wire: 'intelligence-wire/file-oracle', userExperience: 'File System Intelligence — semantic file indexing, visual search with CLIP + Florence, and duplicate detection. Understands your files by content, not just name.' },
  { id: 'EXT-029', slug: 'windows-notification-cortex', name: 'Windows Notification Cortex', engines: ['GPT', 'Claude', 'Inflection'], ring: 'Interface Ring', wire: 'intelligence-wire/notification', userExperience: 'Smart Notification Intelligence — empathic notification composing and urgency scoring. GPT drafts, Claude refines, Inflection adds empathy.' },
  { id: 'EXT-030', slug: 'windows-shell-intelligence', name: 'Windows Shell Intelligence', engines: ['Codex', 'CodeLlama', 'DeepSeek'], ring: 'Build Ring', wire: 'intelligence-wire/shell', userExperience: 'Shell & Explorer AI — context-menu intelligence for file operations, batch rename, script generation, and code analysis. Codex + CodeLlama + DeepSeek powering your shell.' },
  { id: 'EXT-031', slug: 'windows-terminal-forge', name: 'Windows Terminal Forge', engines: ['Codex', 'DeepSeek', 'Phi'], ring: 'Build Ring', wire: 'intelligence-wire/terminal', userExperience: 'Terminal & PowerShell AI — intelligent command generation, explanation, and autocomplete for PowerShell, CMD, and WSL. Codex + DeepSeek + Phi in your terminal.' },
  { id: 'EXT-032', slug: 'edge-ai-assistant', name: 'Edge AI Assistant', engines: ['GPT', 'Claude', 'Gemini', 'Phi'], ring: 'Interface Ring', wire: 'intelligence-wire/edge-assistant', userExperience: 'Edge side panel AI assistant — multi-model reasoning with GPT + Claude + Gemini + Phi fused through phi-weighted scoring. Ask anything from the Edge sidebar.' },
  { id: 'EXT-033', slug: 'edge-tab-analyzer', name: 'Edge Tab Analyzer', engines: ['Embeddings', 'Claude', 'Rerankers'], ring: 'Memory Ring', wire: 'intelligence-wire/edge-tabs', userExperience: 'Edge side panel tab analyzer — semantic content extraction, readability scoring, entity detection, and page summarization for any open tab.' },
  { id: 'EXT-034', slug: 'edge-prompt-lab', name: 'Edge Prompt Lab', engines: ['GPT', 'Claude', 'Llama', 'DeepSeek'], ring: 'Build Ring', wire: 'intelligence-wire/edge-prompts', userExperience: 'Edge side panel prompt engineering lab — template library, multi-model prompt testing, and response comparison across GPT + Claude + Llama + DeepSeek.' },
  { id: 'EXT-035', slug: 'edge-context-engine', name: 'Edge Context Engine', engines: ['Embeddings', 'GPT', 'Command R', 'Florence'], ring: 'Memory Ring', wire: 'intelligence-wire/edge-context', userExperience: 'Edge side panel context intelligence — builds running knowledge from your browsing session with topic tracking, entity graphs, and context summaries.' }
];
